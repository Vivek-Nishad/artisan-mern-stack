...
export const register = (userData) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.post(
    //   BackendUrl ? `${BackendUrl}/api/v1/register` : `/api/v1/register`,
    //   userData,
    //   config
    // );
...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    //   BackendUrl ? `${BackendUrl}/api/v1/me` : `/api/v1/me`
    // );
...
export const logout = () => async (dispatch) => {
  try {
    // await axios.get(
    //   BackendUrl ? `${BackendUrl}/api/v1/logout` : `/api/v1/logout`
    // );
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    //   BackendUrl ? `${BackendUrl}/api/v1/me/update` : `/api/v1/me/update`,
    //   userData,
    //   config
    // );
...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.get(
    //   BackendUrl ? `${BackendUrl}/api/v1/admin/users` : `/api/v1/admin/users`
    // );
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.get(`${BackendUrl}/api/v1/admin/user/${id}`);
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.delete(`${BackendUrl}/api/v1/admin/user/${id}`);
