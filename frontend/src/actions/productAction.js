...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      // let link = BackendUrl
      //   ? `${BackendUrl}/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}`
      ...
      if (category) {
        // link = BackendUrl
        //   ? `${BackendUrl}/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&ratings[gte]=${ratings}`
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.delete(`${BackendUrl}/api/v1/admin/product/${id}`);
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.put(
    //   BackendUrl ? `${BackendUrl}/api/v1/review` : `/api/v1/review`,
    //   reviewData,
    //   config
    // );
