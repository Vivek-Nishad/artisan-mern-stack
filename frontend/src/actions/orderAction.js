...
export const createOrder = (order) => async (dispatch) => {
  try {
    ...
    //   BackendUrl ? `${BackendUrl}/api/v1/order/new` : "/api/v1/order/new",
    //   order,
    //   config
    // );
...
export const myOrders = () => async (dispatch) => {
  try {
    ...
    //   BackendUrl ? `${BackendUrl}/api/v1/orders/me` : "/api/v1/orders/me"
    // );
...
export const getAllOrders = () => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.get(
    //   BackendUrl ? `${BackendUrl}/api/v1/admin/orders` : "/api/v1/admin/orders"
    // );
...
export const getOrderDetails = (id) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.get(
    //   BackendUrl ? `${BackendUrl}/api/v1/order/${id}` : `/api/v1/order/${id}`
    // );
